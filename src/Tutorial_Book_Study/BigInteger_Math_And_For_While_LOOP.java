...
import java.util.*;
import java.math.*;
public class BigInteger_Math_And_For_While_LOOP {
    public static void main(String args []){
        ...
        while(X2.compareTo(new BigInteger("5"))<=0){
            System.out.println(X2);
            X2 = X2.add(BigInteger.ONE);
        }
        for(X2=new BigInteger("6");X2.compareTo(new BigInteger("10"))<=0;X2=X2.add(BigInteger.ONE)){
            System.out.println(X2);
        }
    }
}
